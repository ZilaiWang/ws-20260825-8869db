...
| R1-0 proposal 重排 | P03-F fold-specific 教师作用于 M1 全部 55,548 个 OOF 候选；同大类重分类、分数融合、outer cross-fit，并与冻结 C2 比较 | 已预注册，等待服务器 | 先做推理期域迁移快筛；有信号才进入 proposal-domain 短微调 |
