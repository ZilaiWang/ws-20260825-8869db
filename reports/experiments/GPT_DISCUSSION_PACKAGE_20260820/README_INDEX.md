...
> 用途: 给外部 AI(GPT)深度讨论"如何设计 YOLO 独创性大改、把指标推到最好"的完整输入包。
> 建议阅读顺序: **00 主文档(深度版) → 01 赛题方案 → 02-10 创新评估 → 11-15 N2-CFG → 16-18 M3 → 19-21 时延 → 22-33 基线与历史 → 34-37 数据**。
> 核心内容: 00 主文档含 ① 赛题与 25 细类分布 ② 四模型阈值曲线全表 ③ 6 大问题深度解剖
> (现象/硬数据/根因/影响/方向) ④ 激进目标与达成路径 ⑤ 8 个 YOLO 大改方向弹药(含设计问题)。
...
| # | 文件 | 内容 |
|---|---|---|
| 00 | MAIN_STATUS_AND_PROBLEMS_20260820.md | **主文档(深度版)**: 进度/25细类分布/阈值曲线/6大问题深度解剖/激进目标/8大改方向弹药(必读) |
