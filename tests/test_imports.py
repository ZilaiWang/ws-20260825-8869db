...
@pytest.mark.parametrize(
    ...
    [
        "rsdet",
        "rsdet.analysis.crop_manifest",
        "rsdet.analysis.object_visibility",
        "rsdet.contracts",
        "rsdet.data.crop_classification",
        "rsdet.data.datasets",
        ...
        "rsdet.features.p04_inputs",
        "rsdet.features.p04_probe",
        "rsdet.features.p04_teachers",
        "rsdet.models.base",
        "rsdet.models.crop_classifier",
