...
# Duration ablation for plan 15 progressive resolution adaptation.  This is a
# fresh 40-epoch run from each mature S1024 fold checkpoint, not a resume of the
# 20-epoch candidate, so the only changed factor is adaptation duration.
...
OUT=${OUT:-/root/autodl-tmp/results/SCALEROUTE-PLAN15-PROGRESSIVE40-CV3-V1}
